...
/*  For templates we use two keywords "template" and "typename"
The second keyword can always be replaced by word "class"  */

//A template has to be defined before EVERY function!!!
 
template <class DataType>void swapElements(DataType &v1, DataType &v2)
{ 	
 	//Here v1 and v2 are references!
    DataType temp = v1;
    v1=v2;
    v2=temp;
}
